...
#pragma warning disable
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (isFeasibleTargetForPolyFew)
            {
                ...
                if(isPlainSkin)
                {
                    if (GUILayout.Button("<size=14><b>POLY FEW</b></size> <size=7><b>v6.6</b></size>", style)) { toolMainFoldout = !toolMainFoldout; }
                }
                else
                {
                    if (GUILayout.Button("<size=14><color=#A52A2AFF><b>POLY FEW</b></color></size> <size=7><b><color=#A52A2AFF>v6.6</color></b></size>", style)) { toolMainFoldout = !toolMainFoldout; }
                }
                ...
                if (GUILayout.Button(content, GUILayout.Width(24), GUILayout.Height(24)))
                {
                    Application.OpenURL("https://brainfail.000webhostapp.com/polyfew_runtime_api_docs/html/class_brain_fail_productions_1_1_poly_few_runtime_1_1_polyfew_runtime.html");
                }
...
#pragma warning disable
        ...
        public void DrawBatchFewUI(bool boxDrawnAlready = false)
        {
            ...
            content = new GUIContent();
            if (isPlainSkin) { content.text = "<size=13><b>BATCH FEW</b></size> <size=7><b>v2.3</b></size>"; }
            else { content.text = "<size=13><b><color=#A52A2AFF>BATCH FEW</color></b></size> <size=7><b><color=#A52A2AFF>v2.3</color></b></size>"; }
            ...
            if (FoldoutBatchFew)
            {
                ...
                if (GUILayout.Button(content, style, GUILayout.Width(134), GUILayout.Height(17), GUILayout.ExpandWidth(false)))
                {
                    ...
                    if (lastRect != null)
                    {
                        ...
                        {
                            RegardChildren = value;
                        },
                        () =>
                        {
                            return RegardChildren;
                        });
                ...
                content.tooltip = "Convert skinned meshes to non skinned/static meshes in the selected object. Please note that all animation data and bones hierarchy from the skinned mesh(es) will be lost. If \"Regard Children\" option is true then all the deep nested skinned meshes under this object will also be converted, otherwise only the skinned mesh renderer if any attached to this particular object is considered.";
                ...
                if (didPressButton)
                {
                    if (Selection.gameObjects.Length == 1)
                    {
                        ...
                        try
                        {
                            ...
                            }, RegardChildren, GenerateUV2batchfew);
                        }
